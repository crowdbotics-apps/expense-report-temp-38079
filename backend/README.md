...
## Project Structure
    ...
    ├── expense_report_temp_38079  # Django project configurations
...
1. Clone this repo and `cd expense_report_temp_38079`
...
2. Clone this repo and `cd expense_report_temp_38079`
